...
const EditTaskModal = ({close, task, inputsHandler, handleCheckboxChange, saveTodo}: Props) => {
    console.log("TASK EDITMODAL: ", task)
  return (
    <div className='z-50 fixed overflow-hidden top-0 left-0 w-full h-screen bg-[#3d3c3999]' aria-labelledby="modal-title" role="dialog">
        <div className='bg-white w-full h-full rounded-t-2xl mt-4 p-4 showModal'>
            <div className='flex justify-between items-center min-h-[50px]'>
                ...
                <button onClick={saveTodo} className='text-gray-100 bg-customBlack py-3 px-10 rounded-md max-w-[220px]'>Edit</button>
            </div>
