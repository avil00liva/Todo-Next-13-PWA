...
const TodoCardMenu = ({edit, deletefn}: Props) => {
  return (
    <div className='absolute top-2 right-2 h-[150px] min-w-[80%] bg-gray-900 rounded-md'>
        <div className='relative h-full w-full flex items-center justify-around'>
            <div className='flex flex-col items-center justify-center w-[60px] h-[60px] cursor-pointer border-white border rounded-md'>
                <button className='font-bold h-fit w-fit text-xl' onClick={edit}>
                    <svg fill="#fff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="40px" height="40px" viewBox="0 0 494.936 494.936" xmlSpace="preserve">
                        <g>
                            <g>
            ...
            <div className='w-[60px] h-[60px] cursor-pointer rounded-md bg-red-400 flex justify-center items-center' onClick={deletefn}>
                <button>
